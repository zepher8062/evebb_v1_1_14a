...
function preparse_tags($text, &$errors, $is_signature = false)
{
	...
	$tags = array('quote', 'code', 'b', 'i', 'u', 's', 'ins', 'del', 'em', 'color', 'colour', 'url', 'email', 'img', 'list', '*', 'h', 'size', 'char', 'contract', 'item', 'route', 'market', 'chat', 'dest', 'fitting');
	...
	$tags_inline = array('b', 'i', 'u', 's', 'ins', 'del', 'em', 'color', 'colour', 'h', 'size', 'char', 'contract', 'item', 'route', 'market', 'chat', 'fitting');
